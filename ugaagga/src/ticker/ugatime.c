...
const float *get_battle_bonus (void)
{
  ...
  float *bonus = mp_malloc(3 * sizeof (float));
  int i;
...
{
  static const struct godbonus bonus[][3] = {
    // AGGA       NONE       UGA
    {{.00, .15},{.00, .00},{.00, .00}}, // Agga
    {{.00, .10},{.00, .00},{.00, .00}}, // Eisigkeit
    {{.00, .00},{.00, .00},{.10, .00}}, // Schnehbrandh
    {{.00, .00},{.00, .00},{.15, .00}}, // Binenschtich
    {{.00, .00},{.00, .00},{.20, .00}}, // Brrunfhd
    {{.00, .00},{.00, .00},{.25, .00}}, // Uga
    {{.00, .00},{.00, .00},{.30, .00}}, // Ernte
    {{.00, .30},{.00, .00},{.00, .00}}, // Duesternis
    {{.00, .25},{.00, .00},{.00, .00}}, // Verderb
    {{.00, .20},{.00, .00},{.00, .00}}, // Frrost
  };
