...
function science_getScienceDetail($caveID, &$details){
  ...
  // messages
  $messageText = array(
    0 => "Der Forschungsauftrag wurde erfolgreich gestoppt.",
    1 => "Es konnte kein Forschungsauftrag gestoppt werden.",
    2 => "Der Auftrag konnte nicht erteilt werden. Es fehlen die ".
         "notwendigen Voraussetzungen.",
    3 => "Der Auftrag wurde erteilt",
    4 => "Dieses Wissen wird schon in einer anderen Siedlung erforscht",
    5 => "Es wird gerade in einer anderen Siedlung Wissen erforscht, ".
         "dass dieses Wissen ausschlie&szlig;t.");
...
$notenough = TRUE;
    ...
    } else if ($params->SESSION->user['show_unqualified'] && $result !== FALSE && !$science->nodocumentation){
